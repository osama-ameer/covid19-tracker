...
useEffect ( () => {
    async function fetchGlobalData(){
        ...
        const apiRes = await fetch('https://coronavirus-19-api.herokuapp.com/countries')
 ...
 if(check){
  ...
  return (
      ...
      <div >
          ...
          <Typography className={classes.h} variant="h4" component="h2" color="secondary" >
      ...
      <div className={classes.container}>
        ...
        <InputLabel id="demo-simple-select-outlined-label" style={{marginRight: '50px'}}>Select Country</InputLabel>
        <Select
         value={selectItem} 
...
<MenuItem value={'Zimbabwe'}>Zimbabwe</MenuItem>
      ...
      <Typography className={classes.h} variant="h5" component="h2"  >
         World Status
        </Typography>
    ...
    <Card className={classes.card1} variant="outlined" style={{borderBottom: "2px solid blue"}}>
      <CardContent className={classes.content}  >
        ...
        <Typography variant="h5" component="h2">
            <NumberFormat value= {globalData && globalData[0] && globalData[0].active} displayType={'text'} thousandSeparator={true} />
        </Typography>
    ...
    <Card className={classes.card2} variant="outlined" style={{borderBottom: "2px solid red"}}>
      <CardContent className={classes.content}  >
        ...
        <br/>
        <Typography variant="h5" component="h2">
            <NumberFormat value={globalData && globalData[0] && globalData[0].deaths} displayType={'text'} thousandSeparator={true} / >
    ...
    <Card className={classes.card3} variant="outlined" style={{borderBottom: "2px solid green"}}>
      <CardContent className={classes.content}  >
        ...
        <br/>
        <Typography variant="h5" component="h2">
            <NumberFormat value={globalData && globalData[0] && globalData[0].recovered} displayType={'text'} thousandSeparator={true}  />
